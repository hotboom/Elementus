...
$fk_elements=E::get(array('type'=>$fk_type['id'],'subtypes'=>true,'limit'=>999));

?>
<select name="<?=$data['name']?>" id="<?=(empty($data['id']) ? 'input_'.$field['name'] : $data['id'])?>" class="form-control selectpicker" data-field="<?=$field['name']?>" data-live-search="true">
